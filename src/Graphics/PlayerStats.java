...
/**
 * This class tracks the statistics of the player, and creates a String
...
public class PlayerStats {
	 ...
	 * @param score     if score is 1, left hoop is the scoring hoop, if score =2
	 *                  right hoop is the soring hoop
	 */
	...
	/**
	 * Creates a String which contains all the statistics. Since it returns an
	 * array, the stats could be printed in multiple orders
	 * 
	 * @return returns an array of Strings which includes the following categories:
	 *         shots taken, shots made, shooting percentage, number of times jumped,
	 *         number of times dashed, distance covered, and energy used
	 */
	public String[] statString() {
		...
		String ret = "You took " + shots + " shot(s) and made " + scorecount
				+ " shot(s) which means that your shooting percentage is " + percent + " percent ";
	...
	/**
	 * Method used to draw the scoreboard to the court
	 * 
	 * @param g Graphics used to draw the scoreboard to the court
	 */
